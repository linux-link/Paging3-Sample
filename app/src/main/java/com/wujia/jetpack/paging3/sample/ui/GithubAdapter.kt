...
class GithubAdapter : PagingDataAdapter<UiModel, RecyclerView.ViewHolder>(REPO_COMPARATOR) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == R.layout.item_list){
            GithubItemViewHolder.create(parent)
        }else{
    ...
    override fun getItemViewType(position: Int): Int {
        return when (getItem(position)) {
            ...
            is UiModel.SeparatorItem -> R.layout.separator_view
